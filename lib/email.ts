  ...
  const { data } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; color: #1f2937;">
        ...
        <p style="color: #6b7280; margin-top: 0;">Hi ${fullName}, we're sorry — your previous session didn't have enough participants to run, so we've moved you to a new available session.</p>
  ...
  const { data } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; color: #1f2937;">
        ...
        <p style="color: #6b7280; margin-top: 0;">Hi ${fullName}, we're sorry — your session has been cancelled due to insufficient participants.</p>
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
...
export async function sendThreeHoursReminderEmail(
  ...
  const { data } = await resend.emails.send({
    from: sender,
    to: email,
    subject: `Important Reminder: Your AEyeCoL Study Session Begins in 3 Hours`,
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; color: #1f2937;">
        <h2 style="color: #111827; margin-bottom: 4px;">Study Session Reminder</h2>
        <p style="color: #374151; margin-top: 0;">Dear ${fullName},</p>
        <p style="color: #374151; line-height: 1.6;">This is a formal reminder that your study session at the AEyeCoL Lab is scheduled to begin in approximately <strong>3 hours</strong>. Please ensure you are able to attend on time.</p>
        ...
        <div style="margin: 16px 0; padding: 14px 16px; background: #fef2f2; border: 1px solid #fca5a5; border-radius: 8px; color: #991b1b; font-size: 14px; line-height: 1.6;">
          <strong>⚠ Cancellation is no longer possible.</strong><br />
          The 3-hour cancellation window has now closed. Your attendance is expected and required. Failing to attend without prior notice is highly disruptive to the research team and other participants who have committed their time. If you are facing a genuine emergency, please contact the study coordinator immediately at <a href="mailto:mingcong.ding@tum.de" style="color: #991b1b;">mingcong.ding@tum.de</a>.
        </div>
        <p style="color: #374151; line-height: 1.6;">We look forward to your participation and thank you for your commitment to this research.</p>
        <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 32px 0 16px;" />
        <p style="color: #9ca3af; font-size: 13px; margin: 0;">Best regards,<br /><strong style="color: #6b7280;">AEyeCoL Research Team</strong></p>
      </div>`,
  });
