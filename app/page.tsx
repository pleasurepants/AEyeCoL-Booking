          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleInfoSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs text-gray-500">We recommend a personal address (like Gmail). If you use TUM email, use <span className="font-medium">name@tum.de</span> or <span className="font-medium">tumid@mytum.de</span>.</p>
              </div>
              <div>
