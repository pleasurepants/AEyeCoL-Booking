          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleInfoSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">Please use a personal email address (e.g. Gmail, GMX, web.de). University email addresses may not receive our notifications.</p>
              </div>
              <div>
